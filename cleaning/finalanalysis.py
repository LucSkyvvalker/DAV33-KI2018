...
# per dataset the mp_price for all commodities
fig, ax = plt.subplots(figsize=(25,12))
rice.groupby(['date','cm_name']).sum()['mp_price'].unstack().plot(ax=ax)
ax.set_xlabel('Date')
ax.set_ylabel('Price')

# per land de mp_price voor elke soort rijst in dat land
